...
"""autogenerated by genpy from action/addintsActionResult.msg. Do not edit."""
import codecs
import sys
...
class addintsActionResult(genpy.Message):
  _md5sum = "15b3feb2be539d8ae5b55be6bf7fb947"
  _type = "action/addintsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action/addintsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(addintsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action.msg.addintsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action.msg.addintsResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.sum,) = _get_struct_i().unpack(str[start:end])
      return self
