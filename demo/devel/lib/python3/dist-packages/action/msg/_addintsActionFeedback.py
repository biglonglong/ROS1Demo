...
"""autogenerated by genpy from action/addintsActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class addintsActionFeedback(genpy.Message):
  _md5sum = "fda196d463465ef1ac736abc128ffc57"
  _type = "action/addintsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action/addintsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(addintsActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = action.msg.addintsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action.msg.addintsFeedback()
