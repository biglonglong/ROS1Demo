...
"""autogenerated by genpy from action/addintsAction.msg. Do not edit."""
import codecs
import sys
...
class addintsAction(genpy.Message):
  _md5sum = "7440ec3d2bac9f387e12749d07af9110"
  _type = "action/addintsAction"
...
"""
  ...
  _slot_types = ['action/addintsActionGoal','action/addintsActionResult','action/addintsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(addintsAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = action.msg.addintsActionGoal()
      if self.action_result is None:
        self.action_result = action.msg.addintsActionResult()
      if self.action_feedback is None:
        self.action_feedback = action.msg.addintsActionFeedback()
    else:
      self.action_goal = action.msg.addintsActionGoal()
      self.action_result = action.msg.addintsActionResult()
      self.action_feedback = action.msg.addintsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action_result.result.sum, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.sum, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
