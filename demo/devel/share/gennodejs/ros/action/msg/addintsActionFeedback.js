...
class addintsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new addintsFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = addintsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new addintsActionFeedback(null);
    ...
    data.feedback = addintsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new addintsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = addintsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new addintsFeedback()
    }
...
module.exports = addintsActionFeedback;
