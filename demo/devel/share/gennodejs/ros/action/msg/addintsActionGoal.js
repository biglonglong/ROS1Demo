...
class addintsActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = addintsGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new addintsActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = addintsGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new addintsGoal()
    }
...
module.exports = addintsActionGoal;
